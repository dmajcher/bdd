/****************************************************************************
** Meta object code from reading C++ file 'GuiInterface.hpp'
**
...
#include "../qt/GuiInterface.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'GuiInterface.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 28, 11)
    ...
    "GuiInterface\0searchSigSlot\0\0std::string\0"
};
...
void GuiInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->searchSigSlot((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject GuiInterface::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_GuiInterface.data,
